...
const ubcAwards = [
  ...
  },
  {
    ...
    amount: 1250,
    numberOfAwards: 8000,
    description: 'Recognizes the 8,000 graduates with the top academic achievement in the province. Academic achievement is based on the subset of grades 10–12 courses that are used to meet graduation requirements (including electives). The average calculated for the BC Achievement Scholarship is different from a student\'s GPA. For each eligible student, the final percentages from their subset of courses are used to automatically calculate an average to determine which 8,000 graduates have the top marks.',
    category: 'Provincial Merit Scholarship',
    eligibility: {
      region: ['British Columbia'],
      requiredYear: ['Graduating'],
      citizenshipRequired: ['Canadian Citizen', 'Permanent Resident'],
      academicRequirement: 'Top 8,000 graduates in BC based on grades 10-12 courses',
      languageArts12Minimum: 'B (73% or above)',
      transferStandingLimit: 'No more than one Transfer Standing (TS) or Standing Granted (SG) among course marks used to satisfy graduation requirements',
    },
    applicationProcess: 'No application required - automatically considered if eligible',
    voucherMailed: 'November',
    voucherExpiry: '5 years from issue date',
    requiredDocumentation: ['Must be reported by school with Canadian citizen or permanent resident status by August 31'],
    sourceUrl: 'https://www2.gov.bc.ca/gov/content/education-training/k-12/support/scholarships/provincial-scholarships/bc-achievement-scholarships'
  },
  {
    ...
    amount: 5000,
    numberOfAwards: 55,
    description: 'Awarded to well-rounded high school graduates who have demonstrated service and leadership, both at school and in their communities, and who show aptitude for and commitment to their chosen career or area of post-secondary study. Each secondary school in B.C. may nominate one eligible student for this scholarship.',
    category: 'Provincial Leadership Scholarship',
    eligibility: {
      region: ['British Columbia'],
      requiredYear: ['Graduating'],
      citizenshipRequired: ['Canadian Citizen', 'Permanent Resident'],
      academicRequirement: 'Minimum "B" average in grades 11 and 12 courses required for graduation',
      leadershipRequired: true,
      communityServiceRequired: true,
    },
    applicationProcess: 'Seek school nomination, then apply online by mid-February',
    applicationDeadline: 'Tuesday, February 17, 2026 at 3:00 PM',
    selectionProcess: 'Written statements assessed by BC teachers, approximately 80 candidates shortlisted, resumes assessed, reference letters considered, 55 students selected by consensus',
    voucherMailed: 'October',
    voucherExpiry: '5 years from issue date',
    requiredDocumentation: [
      'School nomination (one per school)',
      'Online application',
      'Resume',
      'Written statement',
      'Two reference letters',
    ],
    additionalNotes: 'Students may apply for both BC Excellence and Pathway to Teacher Education scholarships, but can only be awarded one',
    sourceUrl: 'https://www.gov.bc.ca/bcexcellencescholarship'
  },
  {
    id: 'district-authority-scholarship',
    name: 'District/Authority Scholarship',
    type: 'Scholarship',
    amount: 1250,
    numberOfAwards: 5500,
    description: 'Awarded to high school graduates who have demonstrated excellence in their chosen area. Scholarships are proportionally distributed across school districts and the independent school system based on September 30 Grade 12 enrolments. The Ministry sets core eligibility requirements and general guidelines; local scholarship committees determine awarding criteria and select conditional recipients.',
    category: 'Provincial Excellence Scholarship',
    eligibility: {
      region: ['British Columbia'],
      requiredYear: ['Graduating'],
      citizenshipRequired: ['Canadian Citizen', 'Permanent Resident'],
      graduationRequired: 'BC Certificate of Graduation (Dogwood Diploma) or BC Adult Graduation Diploma (Adult Dogwood) by August 31',
      excellenceArea: [
        'Indigenous Languages and Culture (demonstrated at school or in the community)',
        'Fine Arts (Visual Arts, Dance, Drama, Music)',
        'Applied Design, Skills and Technologies (Business Ed, Technology Ed, Home Economics)',
    ...
    applicationProcess: 'Apply through school or district - local scholarship committee determines criteria',
    voucherMailed: 'November',
    voucherExpiry: '5 years from issue date',
    requiredDocumentation: [
      'Application to local scholarship committee',
      'Evidence of outstanding achievement in chosen area',
      'Portfolio, project, research paper, performance, presentation, demonstration, or interview (as required by district)',
      'Two reference letters from teachers and/or community members',
    ],
    sourceUrl: 'https://www2.gov.bc.ca/gov/content/education-training/k-12/support/scholarships/provincial-scholarships/district-authority-scholarships'
  },
  {
    id: 'pathway-teacher-education-scholarship',
    name: 'Pathway to Teacher Education Scholarship',
    type: 'Scholarship',
    amount: 5000,
    numberOfAwards: 20,
    description: 'Awarded to outstanding high school graduates who have demonstrated a commitment to and aptitude for a career in K–12 teaching. The award voucher is redeemable when a student registers and attends a teacher education program in one of the BC Faculties of Education. The program must lead to eligibility to apply for a B.C. teaching certificate and teach in the K–12 school system in this province.',
    category: 'Provincial Career-Specific Scholarship',
    eligibility: {
      region: ['British Columbia'],
      requiredYear: ['Graduating'],
      citizenshipRequired: ['Canadian Citizen', 'Permanent Resident'],
      academicRequirement: 'Minimum "B" average in grades 11 and 12 final course marks required for graduation',
      specificCourseRequirements: '"B" average in final course marks for Science 11 or 12, Math 11, and Social Studies 11 or 12, with no more than one "C+" (67% or above) final course mark',
      careerCommitment: 'K-12 teaching',
      programRequired: 'Must attend approved teacher education program in Faculty of Education at a BC post-secondary institution',
    },
    applicationProcess: 'Apply online by mid-February',
    applicationDeadline: 'Tuesday, February 17, 2026 at 3:00 PM',
    selectionProcess: 'Written statements assessed by BC teachers, approximately 40 candidates shortlisted, resumes assessed, reference letters considered, 20 students selected by consensus',
    voucherMailed: 'October',
    voucherExpiry: '7 years from issue date',
    requiredDocumentation: [
      'Online application',
      'Resume (specific format required - up to 7 life/volunteer/work experiences relevant to teaching)',
      'Written statement (maximum 500 words explaining why you want to be a teacher)',
      'Two reference letters (one community-related, one school-related)',
    ],
    additionalNotes: 'Students may apply for both Pathway to Teacher Education and BC Excellence scholarships, but can only be awarded one. Voucher has longer redemption period (7 years) compared to other provincial scholarships (5 years).',
    sourceUrl: 'https://www2.gov.bc.ca/gov/content/education-training/k-12/support/scholarships/provincial-scholarships/pathway-to-teacher-education-scholarship'
  },
    {
        id: 'ubc-graduate-bursary',
        name: 'UBC Graduate Student Bursary',
