...
export const awards: Award[] = [
  ...
  },
  {
    ...
    type: 'Prize',
    amount: 750,
    description: 'A $750 prize awarded to the student of Chinese ancestry with the highest scholastic standing in the year preceding their final year in attendance.',
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 40250,
    description: 'Scholarships totalling $40,250 offered to female students who have obtained a baccalaureate degree from UBC and are continuing studies at graduate level or in Medicine, Dentistry or Law.',
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 2400,
    description: 'A scholarship of $2,400 offered to women students entering UBC for the first time. Preference given to a student with demonstrated interest in hiking and cross-country skiing.',
    category: 'Women\'s Scholarship',
    eligibility: {
      campus: ['Vancouver'],
      gender: ['Female'],
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 4050,
    description: 'Scholarships totalling $4,050 for outstanding undergraduate and graduate students, with preference for students whose parents or themselves are affiliated with the Knights Pythias in BC and/or are majoring in mathematics or in Applied Science.',
    category: 'Affiliation Scholarship',
    eligibility: {
      campus: ['Vancouver', 'Okanagan'],
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 1200,
    description: 'A $1,200 scholarship for active members of the ILWU in good standing, dependents, and their sons and daughters.',
    category: 'Affiliation Scholarship',
    eligibility: {
      affiliation: 'ilwu',
      citizenshipRequired: ['Canadian Citizen', 'Permanent Resident', 'Refugee'],
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 1500,
    description: 'Four scholarships of $1,500 each for active members, dependents, and sons and daughters of members in good standing of the ILWU, proceeding to first year.',
    category: 'Affiliation Scholarship',
    eligibility: {
      requiredYear: [1],
      affiliation: 'ilwu',
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 1500,
    description: 'Three scholarships of $1,500 each for active members, dependents, and sons and daughters of members in good standing of the ILWU.',
    category: 'Affiliation Scholarship',
    eligibility: {
      affiliation: 'ilwu',
      citizenshipRequired: ['Canadian Citizen', 'Permanent Resident', 'Refugee'],
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 7800,
    description: 'Scholarships totalling $7,800 for women students who have completed at least one year at UBC with sound academic standing. Special consideration given to students active in women\'s organizations.',
    category: 'Women\'s Scholarship',
    eligibility: {
      campus: ['Vancouver'],
      gender: ['Female'],
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 1400,
    description: 'A scholarship of $1,400 for students whose homes are in School District No. 83 (N. Okanagan – Shuswap).',
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 2000,
    description: 'A scholarship of $2,000 for sons, daughters or legal dependents of members of UA Plumbers and Steamfitters, Local 170, or employees of contributing firms.',
    category: 'Affiliation Scholarship',
    eligibility: {
      campus: ['Vancouver', 'Okanagan'],
      requiredYear: [1],
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 2000,
    description: 'Awards totaling $2,000 for students serving or who have served in Canadian Armed Forces, or who have volunteered with organizations supporting veterans. Preference given to students who completed an IVET certificate program.',
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 900,
    description: 'A scholarship of $900 based on high scholastic standing and community service. Preference given to a Sikh student.',
  ...
  },
  {
    ...
    type: 'Scholarship',
    amount: 1000,
    description: 'Six scholarships of $1,000 each (3 for entering students, 3 for continuing) for members or sons/daughters/legal wards of UFCW Local 1518 members.',
    category: 'Affiliation Scholarship',
    eligibility: {
      affiliation: 'ufcw',
      citizenshipRequired: ['Canadian Citizen', 'Permanent Resident', 'Refugee'],
