            ...
            <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="px-6 py-4 border-b">
                    ...
                    <div className="mt-3 h-3 bg-gray-200 rounded-full overflow-hidden">
                        <div
                            className={`h-full transition-all duration-500 ${analysis.chanceLevel === 'HIGH' ? 'bg-green-500' :
                                    analysis.chanceLevel === 'MEDIUM' ? 'bg-yellow-500' : 'bg-red-500'
                                }`}
                    ...
                    <ul className="space-y-2">
                        {analysis.keyFactors.map((factor, index) => (
                            <li key={index} className="flex items-start">
                                <span className={`mr-2 ${factor.startsWith('✓') ? 'text-green-500' : factor.startsWith('✗') ? 'text-red-500' : 'text-gray-400'}`}>
