  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-4xl mx-auto p-6 space-y-8">
      <div className="bg-white shadow-md rounded-lg p-6">
        <h2 className="text-2xl font-bold text-blue-900 mb-6">UBC Financial Aid Finder</h2>
        <p className="text-gray-600 mb-6">
          Fill out this form to discover scholarships, bursaries, and financial aid opportunities you're eligible for.
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="e.g., Arts, Science, Engineering"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
        ...
        <div className="space-y-4 mt-6">
          <h3 className="text-lg font-semibold text-gray-800 border-b pb-2">Demographic Information</h3>
          ...
          <div className="space-y-2">
            <label className="flex items-center space-x-2">
              ...
              />
              <span className="text-sm text-gray-700">I am an Indigenous student (First Nations, Métis, or Inuit)</span>
            </label>
          ...
          <div className="space-y-2">
            <label className="flex items-center space-x-2">
              <input
                ...
                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
              />
              <span className="text-sm text-gray-700">I have a full-time Canadian government student loan</span>
            </label>
            ...
            <label className="flex items-center space-x-2">
              <input
                ...
                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
              />
              <span className="text-sm text-gray-700">I have demonstrated financial need</span>
            </label>
            ...
            <label className="flex items-center space-x-2">
              <input
                ...
                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
              />
              <span className="text-sm text-gray-700">I am a former youth in care</span>
            </label>
          </div>
        </div>
        ...
        <div className="space-y-4 mt-6">
          ...
          >
            ...
            <span className="text-sm text-gray-500">{showAffiliations ? '▼' : '▶'}</span>
          </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 pl-4">
              <label className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700">Alpha Gamma Delta member</span>
              </label>
              ...
              <label className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700">Canadian Armed Forces (current/former/family)</span>
              </label>
              ...
              <label className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700">Persian/Iranian heritage</span>
              </label>
              ...
              <label className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700">ILWU member/family</span>
              </label>
              ...
              <label className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700">UFCW Local 1518 member/family</span>
              </label>
              ...
              <label className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700">Beem Credit Union member/family</span>
              </label>
              ...
              <label className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700">Sikh community member</span>
              </label>
            </div>
          )}
        </div>
        ...
        <div className="mt-8">
          ...
          >
            {loading ? 'Finding matches...' : 'Find My Scholarships & Bursaries'}
          </button>
        </div>
      </div>
    </form>
